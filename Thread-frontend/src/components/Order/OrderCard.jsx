...
const OrderCard = () => {
    ...
    return (
        <div onClick={()=>navigate(`/account/order/${5}`)} className='p-5 shadow-md shadow-black hover:shadow-2xl border border-amber-50'>
            <Grid container spacing={2} sx={{ justifyContent: "space-between" }}>
                ...
                <Grid item sx={4}>
                    ...
                    {false && <p>
                        <span>
                            Expected Delivery On Auguest 30
                        </span>
                    </p>}
                </Grid>
            </Grid>
