...
const CartItem = () => {
    return (
        <div className='p-5 shadow-lg border border-amber-50 rounded-md'>
            <div className='flex items-center'>
                ...
                <div className='ml-5 space-y-1'>
                    ...
                    <div className='flex space-x-5 items-center  text-gray-900 pt-6'>
                        <p className='font-semibold'>LKR199</p>
                        <p className='opacity-50 line-through'>LKR211</p>
            ...
            <div className='lg:flex items-center lg:space-x-10 pt-4'>
                <div className='flex items-center space-x-2'>
                    ...
                    <span className='py-1 px-7 border border-amber-50 rounded-sm'>3</span>
